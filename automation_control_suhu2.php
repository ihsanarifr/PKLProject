<?php
function automation_control2(){
	//echo exec("/www/cgi-bin/sensor1");
	$mentah_suhu = shell_exec("cat /sys/bus/iio/devices/iio:device0/in_voltage3_raw");
	...
	if($temperature > $suhu)
	{
		...
		shell_exec("echo in > /sys/class/gpio/gpio45/direction");
